...
function ProfileCard() {
  ...
  return (
    <div className="flex flex-col justify-center">
      ...
      <div className="square flex justify-center shadow-[3px_3px_4px_#C9CBF0] border border-primary rounded-lg w-80 h-72 mx-auto relative top-[-80px]">
        <div className="profile-details text-primary text-center">
          ...
          <button
            ...
            className="border border-primary text-primary mt-4 py-2 px-[2.5rem] rounded-[20px]"
            type="button"
          >
            Edit Profile
          </button>
